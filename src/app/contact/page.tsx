...
<div>
  <div >
    <h1 className='font-semibold ml-[490px] text-4xl'>Get In Touch With Us</h1>
  <p className='font-normal font-xs ml-[380px]'>For More Information About Our Product & Services. Plz Feel Free To Drop Us</p>
  <p className='font-normal font-xs ml-[400px]'> An Email. Our Staff Always Be There To Help You Out. Do Not Hesitate!</p>
  </div>

<div className="grid md:grid-cols-2 items-start gap-4 max-md:gap-12 max-w-6xl mx-auto py-6  font-[sans-serif] w-[900px] h-[700px] ">
      <div className="">
        ...
        <div className="space-y-8 mt-8">
          <div className="flex">
            ...
            <div className="ml-4">
              <h4 className="text-gray-800 text-base font-semibold">Address</h4>
              <p className="text-xs mt-1">236 5th SE Avenue, New</p>
              <p className="text-sm mt-4">York NY10000, United States</p>
            </div>
          </div>
          ...
          <div className="flex">
            ...
            <div className="ml-4">
              <h4 className="text-gray-800 text-base font-semibold">Phone</h4>
              <p className="text-xs mt-1">Mobile: +(84) 546-6789</p>
              <p className="text-sm mt-4">Hotline: +(84) 456-6789</p>
            </div>
          </div>
          ...
          <div className="flex">
            ...
            <div className="ml-4">
              <h4 className="text-gray-800 text-base font-semibold">Working Time</h4>
              <p className="text-xs mt-1">Monday-Friday: 9:00 - 22:00
              </p>
              <p className="text-sm mt-4">Saturday-Sunday: 9:00 - 21:00</p>
            </div>
     ...
     <div>
       ...
       <textarea placeholder='Hi! i’d like to ask about' rows={6}
         className="w-full rounded-md px-4 border text-sm pt-2.5 outline-blue-500"></textarea>
     </div>
     <button type='button'
       className="text-white bg-green-400 hover:bg-green-800  font-semibold rounded-md text-sm px-6 py-3 w-[200px]">Submit</button>
   </form>
